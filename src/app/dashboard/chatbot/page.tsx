...
export default function ChatbotPage() {
    ...
    const { sessions, activeSession, isLoading, addMessage, createNewSession, deleteSession, commandIsLoading, loadSession } = useChat();
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-[280px_1fr] h-[calc(100vh-8rem)] gap-6">
            ...
            <div className="hidden md:flex flex-col gap-4 border-r pr-6">
                ...
                <ScrollArea className="h-[9.5rem] -mx-2">
                                ...
                                <div className={cn("max-w-xl rounded-lg p-3", message.isUser ? "bg-primary text-primary-foreground" : "bg-muted")}>
                                     <div className="flex items-center gap-2">
                                        ...
                                        {!message.isUser && message.audio && (
                                            <Button size="icon" variant="ghost" className="h-6 w-6 shrink-0" disabled>
